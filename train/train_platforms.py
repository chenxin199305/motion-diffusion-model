"""
Training platform base class and implementations for Not-implemented, ClearML, TensorBoard, and WandB.

不同的训练平台基类和实现，包括 NoPlatform, ClearML, TensorBoard 和 WandB。
"""
